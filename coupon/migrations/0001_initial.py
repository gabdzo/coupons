# Generated by Django 2.1.5 on 2019-08-02 09:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('combinable', models.BooleanField(default=False, verbose_name='possible to combine with other coupons')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='coupon',
            name='coupon_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coupons', to='coupon.CouponType', verbose_name='coupon type'),
        ),
    ]
